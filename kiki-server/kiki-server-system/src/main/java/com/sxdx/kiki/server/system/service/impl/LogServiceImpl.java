...
import com.sxdx.kiki.server.system.mapper.LogMapper;
...
public class LogServiceImpl extends ServiceImpl<LogMapper, Log> implements ILogService {
    ...
    public IPage<Log> findLogs(Log log, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "createTime", KikiConstant.ORDER_DESC, true);
    ...
    public void saveLog(ProceedingJoinPoint point, Log log) throws JsonProcessingException {
        ...
        com.sxdx.kiki.common.annotation.Log logAnnotation = method.getAnnotation(com.sxdx.kiki.common.annotation.Log.class);
