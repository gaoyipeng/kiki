package com.sxdx.kiki.server.system.helper;


import com.alibaba.fastjson.JSONObject;
import com.google.common.io.Files;
import com.sxdx.kiki.common.annotation.Helper;
...
import com.sxdx.kiki.server.system.utils.AddressUtil;
...
public class GeneratorHelper {
    ...
    public void generateEntityFile(List<Column> columns, GeneratorConfig configure) throws Exception {
        ...
        columns.forEach(c -> {
            c.setField(KikiUtil.underscoreToCamel(StringUtils.lowerCase(c.getName())));
    ...
    public void generateMapperXmlFile(List<Column> columns, GeneratorConfig configure) throws Exception {
        ...
        JSONObject data = toJSONObject(configure);
        columns.forEach(c -> c.setField(KikiUtil.underscoreToCamel(StringUtils.lowerCase(c.getName()))));
        data.put("columns", columns);
