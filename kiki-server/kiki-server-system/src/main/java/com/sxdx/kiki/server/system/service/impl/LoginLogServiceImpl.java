...
import com.sxdx.kiki.common.utils.HttpContextUtil;
import com.sxdx.kiki.common.utils.IPUtil;
import com.sxdx.kiki.common.utils.SortUtil;
import com.sxdx.kiki.server.system.mapper.LoginLogMapper;
...
public class LoginLogServiceImpl extends ServiceImpl<LoginLogMapper, LoginLog> implements ILoginLogService {
    ...
    public IPage<LoginLog> findLoginLogs(LoginLog loginLog, QueryRequest request) {
        ...
        SortUtil.handlePageSort(request, page, "loginTime", KikiConstant.ORDER_DESC, true);
