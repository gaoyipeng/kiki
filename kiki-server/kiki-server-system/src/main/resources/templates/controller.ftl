...
public class ${className}Controller extends BaseController {
    ...
    public KikiResponse getAll${className}s(${className} ${className?uncap_first}) {
        return new KikiResponse().data(${className?uncap_first}Service.find${className}s(${className?uncap_first}));
    }

    @GetMapping("list")
    @PreAuthorize("hasAnyAuthority('${className?uncap_first}:list')")
    public KikiResponse ${className?uncap_first}List(QueryRequest request, ${className} ${className?uncap_first}) {
    ...
    public void add${className}(@Valid ${className} ${className?uncap_first}) throws KikiException {
        try {
    ...
    public void delete${className}(${className} ${className?uncap_first}) throws KikiException {
        try {
    ...
    public void update${className}(${className} ${className?uncap_first}) throws KikiException {
        try {
