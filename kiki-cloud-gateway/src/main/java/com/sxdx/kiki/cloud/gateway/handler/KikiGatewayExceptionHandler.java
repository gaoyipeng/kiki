package com.sxdx.kiki.cloud.gateway.handler;
 ...
 */
@Slf4j
public class KikiGatewayExceptionHandler extends DefaultErrorWebExceptionHandler {

    public KikiGatewayExceptionHandler(ErrorAttributes errorAttributes, ResourceProperties resourceProperties,
